...
<body>  
    ...
    <div id="admin-dashboard" style="display: none;">
        ...
        <ul class="tabs">
            <li><a onclick="openTab('Dash Board')">Dash Board</a></li>
            <li><a onclick="openTab('Admin-info')">Inverntory</a></li>
            <li><a onclick="openTab('sales-expenses')">Sales</a></li>
            <li><a onclick="openTab('order-info')">Order Info</a></li>
        </ul>

        <div id="Dash Board" class="tab-content active-tab">
            ...
            <div class="metric">
                ...
                <?php
                    require_once 'includes/totalproducts.php';
                ?>      
              </div>
              <div class="metric">
                <h2>Low Stock Products</h2>
                <?php
                    require_once 'includes/lowstockproducts.php'
                ?>
              </div>
              <div class="metric">
                <h2>Out of Stock Products</h2>
                <?php
                    require_once 'includes/outofstock.php'
                ?>
            </div>
            <h3>Recent Sales</h3>
                <?php
